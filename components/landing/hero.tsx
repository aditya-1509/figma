...
const Hero: React.FC = () => {
    return (
        <section className="relative min-h-screen flex items-center justify-center pt-24 pb-12 lg:pt-0 lg:pb-0 overflow-hidden">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full h-full">
                <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center h-full">
                    ...
                    <div className="flex flex-col items-start text-left z-20 order-2 lg:order-1 pt-10 lg:pt-0">
                        ...
                        {/* Badge */}
                        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-slate-900 border border-indigo-500/30 text-indigo-300 text-xs font-bold uppercase tracking-widest mb-8 shadow-[0_0_15px_rgba(99,102,241,0.3)]">
                        ...
                        {/* Subtext */}
                        <p className="text-lg text-slate-400 mb-10 max-w-xl font-normal leading-relaxed text-balance">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
                            <button className="inline-flex items-center justify-center px-8 py-4 rounded-full bg-white text-slate-950 hover:bg-slate-200 font-bold transition-all">
                                Explore for Colleges <ArrowRight className="ml-2 w-5 h-5" />
                            </button>
                            <button className="inline-flex items-center justify-center px-8 py-4 rounded-full border border-slate-700 hover:bg-slate-800 text-white font-semibold transition-all">
                                Explore for Brands
                            </button>
                        </div>

                        <div className="mt-8 flex items-center gap-3 text-sm text-slate-500 font-medium cursor-pointer hover:text-indigo-400 transition-colors">
